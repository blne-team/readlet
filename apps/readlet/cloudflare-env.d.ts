/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 43d6fd622cff5df5db417f7a5f5e5912)
// Runtime types generated with workerd@1.20260911.1 2025-09-27 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2_RATE_LIMITER: RateLimit;
	DOWNLOAD_RATE_LIMITER: RateLimit;
	ASSETS: Fetcher;
	NEXT_TELEMETRY_DISABLED: "1";
	READLET_INSTALLATION: "1";
	READLET_R2_BILLING_DAY: "1";
	R2_USAGE: DurableObjectNamespace<import("./worker").R2UsageLedger>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "R2UsageLedger";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_TELEMETRY_DISABLED" | "READLET_INSTALLATION" | "READLET_R2_BILLING_DAY">> {}
}
